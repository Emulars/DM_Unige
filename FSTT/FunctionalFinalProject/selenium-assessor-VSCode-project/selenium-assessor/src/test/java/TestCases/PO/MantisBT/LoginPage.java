...
public class LoginPage {
    ...
    public void set_XPATH_spancontainsadministrator() {
        By elem = By.xpath("//span[contains(.,\'administrator\')]");
        MyUtils.WaitForElementLoaded(driver, elem);
    }

    public void AdministratorLogin(String key1, String key2) {
        set_NAME_username(key1);
        set_NAME_password(key2);
        click_CSSSELECTOR_button();
        set_XPATH_spancontainsadministrator();
    }

    public String set_XPATH_spancontainsadministrator_1() {
        By elem = By.xpath("//span[contains(.,\'administrator\')]");
        MyUtils.WaitForElementLoaded(driver, elem);
